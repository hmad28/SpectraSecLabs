      ...
      <main className="section">
        <div className="wide-container">
          <div className="section-head reveal">
            <div><p className="eyebrow">MISSION BOARD</p><h1>Labs.</h1></div>
            <p>{allChallenges.length}</p>
          </div>
          ...
          <form className="lab-filter-panel" action="/labs">
            <label><span>Search</span><input className="input" name="q" placeholder="Search..." defaultValue={search} /></label>
